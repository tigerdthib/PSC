...
public class ChangeAvatarScene extends PixelScene {

    private static final float BUTTON_HEIGHT	= 24;
    private static final float GAP				= 2;

    private static final String TXT_CHANGE_HERO	= "Do you want to change your hero?";

    private static final String TXT_LOAD	= "Continue Game";
    ...
    public void create() {
        ...
        Badges.loadingListener = new Callback() {
            @Override
            public void call() {
                if (Game.scene() == ChangeAvatarScene.this) {
                    PixelDungeon.switchNoFade( ChangeAvatarScene.class );
                }
            }
        };
    }
    ...
    private class ChallengeButton extends Button {
        ...
        protected void onClick() {
            if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
                ChangeAvatarScene.this.add( new WndChallenges( PixelDungeon.challenges(), true ) {
